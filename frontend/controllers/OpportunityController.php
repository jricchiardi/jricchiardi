...
class OpportunityController extends CustomController
{
    public function actionDownload()
    {
        ...
        $plans = $connection->createCommand("SELECT sp.ClientProductId as '#',
                                                ...
                                                INNER JOIN dbo.Opportunity o ON sp.ClientProductId = o.ClientProductId
        ...
        $row1 = array_merge(['Plantilla Oportunidad', ''], $arr);
        ...
        $title = "Template Oportunidad (" . date("Y-m-d") . ").xls";
