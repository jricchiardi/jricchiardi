...
<div class="row">
	...
	case 'CyOs':	
		...
		$form->field($manualModelImport, 'origen')->dropdownList([ManualImport::ORIGEN_DAS => 'DAS', ManualImport::ORIGEN_DUPONT => 'Dupont'], ['prompt' => 'Seleccionar origen de importación', 'class' => 'mySelectBoxClass']);
		break;
		
	case 'Open Orders':

		$form->field($manualModelImport, 'origen')->dropdownList([ManualImport::ORIGEN_DAS => 'DAS', ManualImport::ORIGEN_DUPONT => 'Dupont', ManualImport::ORIGEN_DELIVORDS => 'DelivOrds', ManualImport::ORIGEN_ORDERS_CRED => 'Orders Cred'], ['prompt' => 'Seleccionar origen de importación', 'class' => 'mySelectBoxClass']);
		break;

	default:

		$form->field($manualModelImport, 'origen')->dropdownList([ManualImport::ORIGEN_DAS => 'DAS', ManualImport::ORIGEN_DUPONT => 'Dupont', ManualImport::ORIGEN_DELIVORDS => 'DelivOrds', ManualImport::ORIGEN_ORDERS_CRED => 'Orders Cred', ManualImport::ORIGEN_DUPONT_SHORT => 'Dupont Short', ManualImport::ORIGEN_DAS_SHORT => 'Das Short'], ['prompt' => 'Seleccionar origen de importación', 'class' => 'mySelectBoxClass']);
	}?>
