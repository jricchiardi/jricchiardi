...
?>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <p class="bg-warning">
                <a href="<?= Url::to(['selling-out/download']) ?>">
                    <img width="40px" height="40px" src="<?= Yii::$app->urlManager->baseUrl ?>/images/download.gif"
                         alt="Descargar Excel de Selling Out"/>
                </a>
                Descargar Excel de Selling Out
            </p>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h1 class="big-title">Importar Archivo de Selling Out</h1>
        </div>
    </div>
<?php
if (!isset($errors)) :
