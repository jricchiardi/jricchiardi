...
<div class="row">
    <div class="col-xs-13 col-sm-13 col-md-3 col-lg-3">
        ...
        $dropDownProduct = (new DropDownList('TradeProductId'))
            ...
            ->autoBind(false)
            ->dataTextField('Description')
            ->dataValueField('ClientMarketingProductId')
...
<script type="text/javascript">
    ...
    function refreshGrid(e) {
        ...
        var ClientMarketingProductId = "";

        if (e) {
            var dataItem = this.dataItem(e.item);
            ClientMarketingProductId = dataItem.ClientMarketingProductId || "";
        }
        ...
        var url = "<?= Url::to(['forecast-marketing/get-clients']) ?>?CountryId=" + CountryId +
            "&ClientMarketingProductId=" + ClientMarketingProductId;
