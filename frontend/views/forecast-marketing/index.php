...
$countries = Country::find()->where(['!=', 'Description', 'Paraguay'])->orderBy('Description')->asArray()->all();

//********************* DEFINE the columns and models ********************
/* DSM */
$dsmField = (new DataSourceSchemaModelField('Dsm'))->type('string');
$dsmColumn = (new GridColumn())
    ->field('Dsm')
    ->title('DSM')
    ->width(150)
    ->lockable(false)
...
<script type="text/javascript">
    ...
    function refreshProductos() {
        ...
        $TradeProductId.dataSource.data([]);
    ...
    function refreshGrid(e) {
        ...
        var url = "<?= Url::to(['forecast-marketing/get-forecast']) ?>?CountryId=" + CountryId +
