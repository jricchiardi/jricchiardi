...
?>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <p class="bg-warning">
                <a href="<?= Url::to(['pioneer-client/download']) ?>">
                    <img width="40px" height="40px" src="<?= Yii::$app->urlManager->baseUrl ?>/images/download.gif"
                         alt="Descargar Excel de Clientes de Pioneer"/>
                </a>
                Descargar Excel de Clientes de Pioneer
            </p>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h1 class="big-title">Importar Excel de Clientes de Pioneer</h1>
        </div>
    </div>
<?php
if (!isset($errors)) :
