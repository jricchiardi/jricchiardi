 ...
 *
 * @property integer $ForecastMarketingId
 ...
 */
class ForecastMarketing extends ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['DsmId', 'TradeProductId', 'CampaignId'], 'required'],
            [['DsmId', 'GmidId', 'TradeProductId', 'CampaignId', 'January', 'February', 'March', 'Q1', 'April', 'May', 'June', 'Q2', 'July', 'August', 'September', 'Q3', 'October', 'November', 'December', 'Q4', 'Total'], 'integer'],
        ];
    }
    ...
    {
        return [
            'ForecastMarketingId' => 'Forecast Marketing ID',
    ...
    {
        return $this->hasOne(User::className(), ['UserId' => 'DsmId']);
    }
