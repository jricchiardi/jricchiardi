...
/**
 * This is the model class for table "ReportComparativeBySellers".
 *
 ...
 */
class ReportComparativeBySellers extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'ReportComparativeBySellers';
    }
    ...
    {
        return [
            [['CampaignId', 'DsmId', 'RsmId', 'Q1ForecastMoreSaleVolume', 'Q2ForecastMoreSaleVolume', 'Q3ForecastMoreSaleVolume', 'Q4ForecastMoreSaleVolume', 'Q1PlanVolume', 'Q2PlanVolume', 'Q3PlanVolume', 'Q4PlanVolume', 'TotalPlanVolume', 'TotalForecastMoreSaleVolume'], 'integer'],
            [['SellerName'], 'string'],
            [['DsmId', 'RsmId'], 'required'],
