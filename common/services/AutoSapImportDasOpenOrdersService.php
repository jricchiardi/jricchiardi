...
use common\models\sap\DasOpenOrders;
use common\models\sap\Elemento;
use common\models\TypeImport;

class AutoSapImportDasOpenOrdersService extends AutoSapImportService
{
    const ARCHIVOS_IMPORTADOS_FOLDER_PATH = "@console/importacion_automatica_sap/das/archivos_importados";
    const FILENAME = "@console/importacion_automatica_sap/das/DasOpenOrders.csv";
...
//    const FILENAME = "Y:\\\\OpenOrders.csv";
    ...
    {
        return TypeImport::AUTOMATIC_DAS_OPEN_ORDERS;
    }
    ...
    {
        return DasOpenOrders::fromCSV($data, $OrderNo, $SoldToCustName, $rowNumber);
    }
