...
class AutoSapImportDelivOpenOrdersService extends AutoSapImportService
{
    const ARCHIVOS_IMPORTADOS_FOLDER_PATH = "@console/importacion_automatica_sap/dupont/archivos_importados";
    const FILENAME = "@console/importacion_automatica_sap/dupont/DelivOpenOrders.csv";
...
//    const FILENAME = "Y:\\\\OpenOrders.csv";
    ...
    {
        return TypeImport::AUTOMATIC_DELIV_OPEN_ORDERS;
    }
    ...
    {
        return DelivOpenOrders::fromCSV($data, $OrderNo, $SoldToCustName, $rowNumber);
    }
