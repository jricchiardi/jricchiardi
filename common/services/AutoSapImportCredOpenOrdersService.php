...
use common\models\sap\CredOpenOrders;
use common\models\sap\Elemento;
use common\models\TypeImport;

class AutoSapImportCredOpenOrdersService extends AutoSapImportService
{
    const ARCHIVOS_IMPORTADOS_FOLDER_PATH = "@console/importacion_automatica_sap/das/archivos_importados";
    const FILENAME = "@console/importacion_automatica_sap/das/CredOpenOrders.csv";
...
//    const FILENAME = "Y:\\\\OpenOrders.csv";
    ...
    {
        return TypeImport::AUTOMATIC_CRED_OPEN_ORDERS;
    }
     ...
     * @return Elemento
     */
    protected function createElemento(array $data, $OrderNo, $SoldToCustNumber, int $rowNumber)
    {
        return CredOpenOrders::fromCSV($data, $OrderNo, $SoldToCustNumber, $rowNumber);
    }
