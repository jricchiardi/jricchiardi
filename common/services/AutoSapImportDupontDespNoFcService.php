...
use common\models\sap\DupontDespNoFc;
use common\models\sap\Elemento;
use common\models\TypeImport;

class AutoSapImportDupontDespNoFcService extends AutoSapImportService
{
    const ARCHIVOS_IMPORTADOS_FOLDER_PATH = "@console/importacion_automatica_sap/dupont/archivos_importados";
    const FILENAME = "@console/importacion_automatica_sap/dupont/DupontDespNoFc.csv";
...
//    const FILENAME = "Y:\\\\FcNoCont.csv";
    ...
    {
        return TypeImport::AUTOMATIC_DUPONT_DESP_NOFC;
    }
    ...
    {
        return DupontDespNoFc::fromCSV($data, $SalesDoc, $SoldToCustName, $rowNumber);
    }
