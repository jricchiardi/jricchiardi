...
class m200513_202409_update_view_export_consolid_marketing extends Migration
{
...
SELECT    fs.CampaignId,
          ...
          fs.ClientMarketingId   AS 'Cliente',
...
FROM (
         ...
         INNER JOIN SaleWithForecastMarketing fs
                    ON fs.ClientMarketingProductId = T.ClientMarketingProductId AND T.CampaignId = fs.CampaignId
         INNER JOIN client_marketing c
                    ON c.ClientMarketingId = fs.ClientMarketingId
